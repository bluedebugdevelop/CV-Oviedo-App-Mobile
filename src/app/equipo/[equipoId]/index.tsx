...
export default function ResumenEquipo() {
  ...
  // Se vuelve a la lista solo si hay a dónde volver: con un equipo, esta
  // pantalla ES la pestaña y una flecha de volver no llevaría a ninguna parte.
  const variosEquipos = sesion.equipos.length > 1

  if (!equipo) {
    return (
      <Pantalla titulo="Equipo" atras={variosEquipos}>
        <Vacio
